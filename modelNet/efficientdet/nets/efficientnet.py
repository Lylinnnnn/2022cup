...
from modelNet.efficientdet.nets.layers import (MemoryEfficientSwish, Swish, drop_connect,
...
class EfficientNet(nn.Module):
    ...
    @classmethod
    def from_pretrained(cls, model_name, load_weights=True, advprop=True, num_classes=1000, in_channels=4):
