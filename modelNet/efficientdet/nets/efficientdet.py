...
from modelNet.efficientdet.utils.anchors import Anchors

from modelNet.efficientdet.nets.efficientnet import EfficientNet as EffNet
from modelNet.efficientdet.nets.layers import (Conv2dStaticSamePadding, MaxPool2dStaticSamePadding,
...
#    net = EfficientDetBackbone(1, 0, False).to(device)
#    print(net)
#
#    summary(model=net,input_size=(3,512,512),batch_size=16)
