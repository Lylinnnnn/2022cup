...
from modelNet.classifier.nets import get_model_from_name
from modelNet.classifier.utils.utils import (cvtColor, get_classes, letterbox_image,
                         preprocess_input)
...
class Classification(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : 'F:\Final\modelNet\classifier\model_data/best.pth',
        "classes_path"  : 'F:\Final\modelNet\classifier\model_data/cls_classes.txt',
        #--------------------------------------------------------------------#
        #   输入的图片大小
        #--------------------------------------------------------------------#
        "input_shape"   : [224, 224],
    ...
    def detect_image(self, image):
        ...
        # # 显示图片
        # text = 'Class:%s Probability:%.3f' %(class_name, probability)
